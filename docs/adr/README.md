...
> **建立 ADR 檔案不會自動修訂 SDD。** 工程師可提出 `proposed` ADR；只有經**專案經理明確核准**，且同步指出受影響 SDD 條號與後續同步方式，才可改為 `accepted`。在核准與同步完成前，一律以 SDD v0.2 為準。
...
| [ADR-0002](./ADR-0002-移除legacy新聞爬蟲.md) | 移除 legacy 新聞爬蟲（取代 DEC-003） | accepted | 2026-08-02 |
